- these are both two different things that form together to make a larger piece of information
- a ***packet*** is a piece of data from the layer 3 network layer containing info like ip header and payload
- a ***frame*** is used at layer 2 data link layer which incapsulates the packets and adds info like mac address
...
- it can be called a summarised version of the osi model
- the four layers are 
		- application
		- transport
		- internet
		- network interface
- the connection establishing process is known as the three way handshake
...
Because TCP reserves system resources on a device, it is best practice to close TCPconnections as soon as possible.
...
- both protocols share some standard headers, which are what is annotated in the table below:
...
# ports
- these are the points where compatible ships dock and exchange their data
- these range from 0 to 65535
- Let's explore some of these other protocols below:
...
|**H**yper**T**extTransfer Protocol (**HTTP**)|80|This protocol powers the World Wide Web (WWW)! Your browser uses this to download text, images and videos of web pages.|
