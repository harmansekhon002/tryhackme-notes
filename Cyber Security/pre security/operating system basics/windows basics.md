...
>at the starting there was ms dos before the gui windows where we had to manually type the commands but in 1985 microsoft released windows 1.0 which was the first windows GUI

## types of windows acc 
1. guest
2. standard
3. admin
## Key Terminology
